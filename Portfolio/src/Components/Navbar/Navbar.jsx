...
const Navbar = () => {
  ...
  return (
    <div className="w-full h-20 sticky top-0 left-0 z-50 bg-bodyColor bg-transparent mdl:bg-bodyColor  mx-auto flex justify-between items-center font-titleFont mdl:border-b-[1px] mdl:border-b-gray-600">
      <div>
